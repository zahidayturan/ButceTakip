      ...
      child: Column(
        ...
        children: [
              ...
              child: Column(
                children: [
                  Padding(
                    ...
                    child: Text(
                      widget.status == "care" ?  "Bütçe Takip bakımda." : "Bütçe Takip güncellendi!",
                      style: TextStyle(
                          fontSize: 44,
                          height: 1,
                          fontFamily: "Nexa4",
                  ...
                  Padding(
                    padding: const EdgeInsets.all(10.0),
                    child: Text(
                      widget.status == "care" ?  "Beklediğiniz için teşekkür ederiz." : "Lütfen  uygulamayı mağazadan güncelleyiniz.",
                      style: TextStyle(
                          fontSize: 32,
                          height: 1,
                          fontFamily: "Nexa3",
          ...
          Column(
            children: [
              Text(
                widget.status == "care" ?  "İletişim İçin" : "",
                style: TextStyle(
                    fontSize: 22,
                    height: 1,
                    fontFamily: "Nexa4",
