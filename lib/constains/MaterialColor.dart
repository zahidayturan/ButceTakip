...
class CustomColors{
  static Color koyuuRenk =  Color(0xFF0D1C26);  // Koyu renk
  static Color sariRenk = const Color(0xFFF2CB05); //Sarı rengimiz
  static Color YaziRenk = const Color(0xFFFFFFFF); //yazı rengi
